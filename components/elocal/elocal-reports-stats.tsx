...
interface ElocalReportStatsProps {
    dateRange: DateRange
    nicheId?: string
    refreshToken?: number
}

export function ElocalReportStats({ dateRange, nicheId, refreshToken }: ElocalReportStatsProps) {
    ...
    const fetchStats = async () => {
        try {
            ...
            console.error("Elocal report stats error:", err)
    ...
    }, [dateRange.from, dateRange.to, nicheId, refreshToken])

    if (loading) {
        return (
            <div className="space-y-4">
                <h3 className="text-orange-500 font-medium">Overview</h3>
